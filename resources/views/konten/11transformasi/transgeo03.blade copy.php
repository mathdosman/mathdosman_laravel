    ...
    <div class="container-xl">
      <div class="row g-2 align-items-center">
        <div class="col">
          ...
          <h2 class="page-title">
            Transformasi Geometri - 03 + Pembahasan
          </h2>
        </div>
      </div>
    </div>
...
<input type="hidden" id="materi" name="materi" value="transgeo-03">
{{-- TOMBOL KIRIM --}}
...
<div class="row text-center">
    <a href="/createtransgeo03" id="kirimsaja" class="btn btn-warning btn-bukti d-none" >SIMPAN JAWABAN</a>
</div>
</form>
{{-- COPY SAMPAI SINI --}}
